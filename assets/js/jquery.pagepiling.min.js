  ...
  e.fn.pagepiling = function (i) {
    ...
    function C() {
      F.get(0).addEventListener
        ? (F.get(0).removeEventListener("mousewheel", b, !1), F.get(0).removeEventListener("wheel", b, !1))
        : F.get(0).detachEvent("onmousewheel", b);
    }
    function k() {
      F.get(0).addEventListener
        ? (F.get(0).addEventListener("mousewheel", b, !1), F.get(0).addEventListener("wheel", b, !1))
    ...
    function N(n, t) {
      ...
      var o = e(n).parent();
      return (
        !!(t < Z.normalScrollElementTouchThreshold && o.is(Z.normalScrollElements)) ||
